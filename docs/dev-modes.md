...
- Full mode: a Linux Docker context (Colima/Lima/Proxmox) with eBPF support.

## Inputs
- `SMART_ADDRESS_LINUX_DOCKER_CONTEXT` (optional) to select the Linux Docker context.
...
- Full mode: Beyla metrics in Prometheus, Pyroscope profiles, and Dockerized service.
